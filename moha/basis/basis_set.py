...
from moha.basis.one_electron import Orbital
...
class BasisSet(list):
    ...
    def append(self,basis):
        ...
        """
        if not isinstance(basis, (Orbital, ContractedGaussian)):
            raise TypeError("Basis must be Orbital or ContractedGaussian instance")
        super().append(basis)
