...
__all__ = ['CCSD_TSolver']

class CCSD_TSolver(object):
    ...
    def kernel(self):
        ...
        log.hline()
        log('Total Energy = {}'.format(hf_results['total_energy']+ECCSD+Et))
        log.hline()
        ...
        "CCSD_energy":ECCSD,
        "CCSD_T_energy":Et,
        "total_energy":hf_results['total_energy']+ECCSD+Et
        }
